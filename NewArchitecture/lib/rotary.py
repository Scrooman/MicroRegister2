...
_DIR_CW = const(0x10)  # type: ignore Clockwise step 
_DIR_CCW = const(0x20)  # type: ignore Counter-clockwise step

# Rotary Encoder States
_R_START = const(0x0) # type: ignore
_R_CW_1 = const(0x1) # type: ignore
_R_CW_2 = const(0x2) # type: ignore
_R_CW_3 = const(0x3) # type: ignore
_R_CCW_1 = const(0x4) # type: ignore
_R_CCW_2 = const(0x5) # type: ignore
_R_CCW_3 = const(0x6) # type: ignore
_R_ILLEGAL = const(0x7) # type: ignore
...
_STATE_MASK = const(0x07) # type: ignore
_DIR_MASK = const(0x30) # type: ignore
...
class Rotary(object):
    ...
    RANGE_UNBOUNDED = const(1) # type: ignore
    RANGE_WRAP = const(2) # type: ignore
    RANGE_BOUNDED = const(3) # type: ignore
